            ...
            <Box backgroundColor="antiquewhite" pt={150} pb="50px">
                <Box maxW="80%" mx={"auto"}>
                    ...
                    <Box backgroundColor="#fff">
                        ...
                        <Flex flexWrap={"wrap"}justify="left" margin="0 10px">
                            {dataItem?.items.map((item,index)=>{
                                return(
                                    <Box m={3} key={index} className="danhmuchover" border="1px solid rgba(0,0,0,.125)" w="185px" borderRadius="0.25rem">
                                        <Link to={`/list-items/${item?.name}`}>
